...
This bench is the C twin for the `.hl`-side coverage in
`hale-lang/bench/micro/form_hashmap_false_sharing.hl`. The
...
- F.32-1 acceptance gate: `.hl` bench >= 2x post-padding.
