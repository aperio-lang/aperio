<!-- Synced from hale-lang/pond/http/client/README.md by tools/sync-pond-docs.sh — do not edit here. -->
...
See [`examples/get-demo/`](https://github.com/hale-lang/pond/tree/main/http/client/examples/get-demo/) for a runnable
end-to-end demo.
