<!-- Synced from aperio-lang/pond/agent/embeddings/README.md by tools/sync-pond-docs.sh — do not edit here. -->
...
```bash
$ aperio build pond/agent/embeddings/examples/topk-demo/
