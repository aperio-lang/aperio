<!-- Synced from aperio-lang/pond/math/matrix/README.md by tools/sync-pond-docs.sh — do not edit here. -->
...
```bash
$ aperio build pond/math/matrix/examples/matmul-demo/
...
- `matrix.ap` — the `Matrix` locus, `Mat` namespace, free-fn
  fallible surface.
- `examples/matmul-demo/main.ap` — end-to-end demo.
