<!-- Synced from aperio-lang/pond/sessions/README.md by tools/sync-pond-docs.sh — do not edit here. -->
...
Depends on [`pond/crypto`](./crypto.md) (`hmac_sha256` +
`constant_time_eq`).
...
// directly post-A3 (lotus-lang f9068fa) — no namespace-lotus
...
locus Routes {
    ...
    fn handle(req: std::http::Request) -> std::http::Response {
        ...
        // `std::http::Response.headers` (C11, lotus-lang `965d828`)
