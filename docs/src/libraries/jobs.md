<!-- Synced from hale-lang/pond/jobs/README.md by tools/sync-pond-docs.sh — do not edit here. -->
...
[`FRICTION.md`](https://github.com/hale-lang/pond/blob/main/jobs/FRICTION.md) for the full chain.
