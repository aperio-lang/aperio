<!-- Synced from hale-lang/pond/sqlite/README.md by tools/sync-pond-docs.sh — do not edit here. -->
...
primitive lands — see [`FRICTION.md`](https://github.com/hale-lang/pond/blob/main/sqlite/FRICTION.md) for the
