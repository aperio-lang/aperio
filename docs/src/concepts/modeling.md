# Modeling — how to think in Hale

> Given the primitives, how do you actually *use* them
...
guarantee Hale makes (wholesale-free at dissolve,
...
(The [`pond`](https://github.com/hale-lang/pond) contrib
...
Every well-shaped Hale program is composed of seven recurring
...
2. **Read working examples.** The
   [`apps/`](https://github.com/hale-lang/hale/tree/main/apps)
