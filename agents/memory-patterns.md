# Memory patterns for `.ap` authors
...
`.ap` authors. Read before writing hot-path code.
...
don't need to know about these — write the natural Aperio shape
...
## Three rules for new Aperio code
...
**Compose these:** the diagnostic workflow that pinned fathom's
SymbolBook residual was
...
The Aperio model is **arenas don't free per-allocation**. Bounded
...
- lotus-lang `fb2a769`, `f042806`, `5b96380`, `cbbebbc`, `f2a4cf4`
