...
Phase 3 capstone — a minimal HTTP server written in Hale,
...
```
cargo run --bin hale -- run examples/http-hello/main.hl
# or with a custom port + accept cap:
cargo run --bin hale -- run examples/http-hello/main.hl 9000 5
```
