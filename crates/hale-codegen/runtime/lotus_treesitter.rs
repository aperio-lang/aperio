//! m96 — Hale std::ts substrate. Tree-sitter wrapper exposing
...
//!
//! Compiled as a staticlib via the sibling `hale-ts-shim`
//! workspace crate — cargo produces `libhale_ts_shim.a` at the
