...
//!   3. Desugar (`aperio_syntax::desugar::desugar_topics`)
...
use aperio_syntax::{parse_source, ast::*};
use aperio_syntax::desugar::desugar_topics;
...
fn build(name: &str, src: &str) -> std::path::PathBuf {
    ...
    bin.push(format!("aperio_test_topic_{}", name));
