...
//! drives pond/crypto off its 140-line pure-Aperio O(N²) workaround.
//!
//! Vectors:
...
//!
//! The .ap program prints each digest as space-separated decimal
...
fn build(name: &str, src: &str) -> std::path::PathBuf {
    ...
    bin.push(format!("aperio_test_crypto_sha256_{}", name));
