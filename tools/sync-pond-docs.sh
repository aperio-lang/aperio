...
# mdbook build.
#
# Pond lives in a separate repo (github.com/hale-lang/pond).
# Each library is its own seed and ships an authoritative
# README.md. This script flattens those into the hale
...
POND_GH="https://github.com/hale-lang/pond/blob/main"
POND_GH_TREE="https://github.com/hale-lang/pond/tree/main"
...
autogen_banner() {
    ...
    local src_path
    if [[ -n "$lib" ]]; then
        src_path="hale-lang/pond/${lib}/README.md"
    else
        src_path="hale-lang/pond/README.md"
    fi
    cat <<EOF
